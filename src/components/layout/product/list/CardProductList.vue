<template>
  <RouterLink :to="`/products/${product.slug}`">
    <div class="relative w-full">
      <img :alt="product.image.name" :src="product.image.src" class="w-full aspect-square" />
    ...
    <div class="flex flex-col items-start">
      ...
      <b class="text-sm uppercase text-quaternary" v-show="product.discountPercent">sale</b>
      <div class="flex flex-col items-start mt-1">
        ...
        <span v-if="product.discountPercent" class="text-quaternary">
